...
import java.util.Scanner;
    ...
    public class ShoppingmallDAO_PlusCart {
        private Scanner scanner = new Scanner(System.in);
        private Connection conn;
        private String loggedInUserID;


        public ShoppingmallDAO_PlusCart() {
            try {
                // JDBC Driver 등록
        ...
        public void Delivery() {
            ...
            try {
                String sql = "SELECT item_order.order_id, item.item_name, item.size, item.price, " +
        ...
        public static void main(String[] args) {
            ShoppingmallDAO_PlusCart shoppingmallDAOPlusCart = new ShoppingmallDAO_PlusCart();
            shoppingmallDAOPlusCart.list();
            shoppingmallDAOPlusCart.startMenu();
        }
